/*!
\file  dlmalloc.c
\brief Doug Lea's malloc library
...
\version\verbatim $Id: dlmalloc.c 1421 2007-04-06 14:37:41Z karypis $ \endverbatim
*/
...
#define internal_malloc(m, b)\
   ((m == gm) ? dlmalloc(b) : mspace_malloc((mspace)m, b))  /* GKMOD here */
#define internal_free(m, mem)\
   ((m == gm) ? dlfree(mem) : mspace_free((mspace)m, mem));  /* GKMOD here */
#else /* MSPACES */
